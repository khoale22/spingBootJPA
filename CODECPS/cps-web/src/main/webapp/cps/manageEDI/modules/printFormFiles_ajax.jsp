...
<form:form
	...
	action="/protected/cps/add" method="POST" commandName="manageEDICandidate"
	enctype="multipart/form-data" >
	<input type="hidden"	name="${_csrf.parameterName}" value="${_csrf.token}"/>
<script type="text/javascript">
	<c:url value="/protected/PrintFormViewerServlet" var="printFormView" />
	<%--<c:url value="/protected/cps/manageEDI/searchEDIcandidate.do?action=printMRT&${_csrf.parameterName}=${_csrf.token}" var="printFormMRTView" />--%>
	<c:url value="/protected/cps/manageEDI/printMRT?${_csrf.parameterName}=${_csrf.token}" var="printFormMRTView" />
