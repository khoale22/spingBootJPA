...
/**
 * Repository to retrieve ingredient categories with count.
 *
 * @author s573181
 * @since 2.1.0
 */
public interface IngredientCategoryRepositoryDelegateWithCount extends IngredientCategoryRepositoryCommon {
	 ...
	 */
	Page<IngredientCategory> findByCategoryDescriptionContains(List<String> categoryDescriptions,
															   Pageable request);
}
