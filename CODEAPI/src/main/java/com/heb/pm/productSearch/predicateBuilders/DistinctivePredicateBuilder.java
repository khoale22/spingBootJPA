 ...
 */
@Service
public class DistinctivePredicateBuilder extends MarketingClaimPredicateBuilder implements PredicateBuilder{
	...
	public ExistsClause<ProductMarketingClaim> buildPredicate(CriteriaBuilder criteriaBuilder,
		...
		return this.buildProductMarketingClaimPredicate(CustomSearchEntry.DISTINCTIVE,
				criteriaBuilder,
				pmRoot,
				queryBuilder,
