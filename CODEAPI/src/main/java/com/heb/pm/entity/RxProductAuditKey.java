...
/**
 * Represents the key for the RX product audit entity.
 */
@Embeddable
@TypeDef(name = "fixedLengthCharPK", typeClass = com.heb.pm.util.oracle.OracleFixedLengthCharTypePK.class)
public class RxProductAuditKey implements Serializable {
	private static final long serialVersionUID = 1L;

	public RxProductAuditKey(){super();}
	...
	public boolean equals(Object o) {
		...
		RxProductAuditKey that = (RxProductAuditKey) o;
