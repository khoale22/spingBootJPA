...
/**
 * Represents the key for the product master audit entity.
 */
@Embeddable
@TypeDef(name = "fixedLengthCharPK", typeClass = com.heb.pm.util.oracle.OracleFixedLengthCharTypePK.class)
public class ProductMasterAuditKey implements Serializable {
	private static final long serialVersionUID = 1L;

	public ProductMasterAuditKey(){super();}
	...
	public boolean equals(Object o) {
		...
		ProductMasterAuditKey that = (ProductMasterAuditKey) o;
