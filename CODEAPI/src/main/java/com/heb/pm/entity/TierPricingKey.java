...
/**
 * This is the key for tier pricing.
 *
 * @author l730832
 * @since 2.13.0
 */
@Embeddable
public class TierPricingKey implements Serializable {
	...
	public boolean equals(Object o) {
		...
		TierPricingKey that = (TierPricingKey) o;
		...
		if (effectiveTimeStamp != null ? !effectiveTimeStamp.equals(that.effectiveTimeStamp) : that.effectiveTimeStamp != null)
			return false;
		return discountQuantity != null ? discountQuantity.equals(that.discountQuantity) : that.discountQuantity == null;
	}
