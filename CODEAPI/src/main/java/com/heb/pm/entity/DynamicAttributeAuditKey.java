...
/**
 * Represents the key of a dynamic attribute audit record.
 *
 */
@Embeddable
...
public class DynamicAttributeAuditKey implements Serializable {
	...
	public String toString() {
		return "DynamicAttributeAuditKey{" +
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof DynamicAttributeAuditKey)) return false;

		DynamicAttributeAuditKey that = (DynamicAttributeAuditKey) o;
	...
	@Override
	public int hashCode() {
		int result = (attributeId ^ (attributeId >>> DynamicAttributeAuditKey.FOUR_BYTES));
		result = DynamicAttributeAuditKey.PRIME_NUMBER * result + (int) (key ^ (key >>> DynamicAttributeAuditKey.FOUR_BYTES));
		result = DynamicAttributeAuditKey.PRIME_NUMBER * result + keyType.hashCode();
		result = DynamicAttributeAuditKey.PRIME_NUMBER * result + sequenceNumber;
		result = DynamicAttributeAuditKey.PRIME_NUMBER * result + sourceSystem;
		return result;
	}
	...
	public static Sort getDefaultSort() {
		return new Sort(new Sort.Order(Sort.Direction.ASC, DynamicAttributeAuditKey.KEY_SORT_FIELD));
	}
}
