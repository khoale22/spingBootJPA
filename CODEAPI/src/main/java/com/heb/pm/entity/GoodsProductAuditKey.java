...
/**
 * Represents the key for the goods product audit entity.
 */
@Embeddable
@TypeDef(name = "fixedLengthCharPK", typeClass = com.heb.pm.util.oracle.OracleFixedLengthCharTypePK.class)
public class GoodsProductAuditKey implements Serializable {
	private static final long serialVersionUID = 1L;

	public GoodsProductAuditKey(){super();}
	...
	public boolean equals(Object o) {
		...
		GoodsProductAuditKey that = (GoodsProductAuditKey) o;
