...
/**
 * Mocks up a function that will return a PageImpl and check for valid inputs on the call.
 *
 * @author d116773
 * @since 2.0.3
 */
class PageImplReturningCallChecker implements Answer<Page<ProductDiscontinue>> {
	...
	/**
	 * Constructs a new PageImplReturningCallChecker.
	 *
	 ...
	 */
	public PageImplReturningCallChecker(int page, int pageSize, Object toCheck) {
		this.page = page;
	 ...
	 * @return An PageImpl with an empty list of ProductDiscontinue objects.
	 * @throws Throwable
	 */
	@Override
	public Page<ProductDiscontinue> answer(InvocationOnMock invocation) throws Throwable {
		...
		return new PageImpl<>(this.getResultList(), null, 1);
	}
