...
public class SalesChannelTest {
	...
	public void setIdTest() {
		SalesChannel obj = getDefaultRecord(DEFAULT_ID, DEFAULT_ABBREVIATION, DEFAULT_DESCRIPTION);
		obj.setId(OTHER_ID);
	...
	public void toStringTest() {
		Assert.assertEquals("SalesChannel{id='D', abbreviation='DEF', description='DEFAULT'}",
	...
	public void hashDifferentCodeTest(){
		SalesChannel obj = getDefaultRecord(DEFAULT_ID, DEFAULT_ABBREVIATION, DEFAULT_DESCRIPTION);
		SalesChannel objb = getDefaultRecord(OTHER_ID, OTHER_ABBREVIATION, OTHER_DESCRIPTION);
	 ...
	 * @return
	 */
	private SalesChannel getDefaultRecord(String id, String abbreviation, String description){
		SalesChannel record = new SalesChannel();
		record.setId(id);
